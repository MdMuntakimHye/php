...
<body>
  <div class="container">
    ...
    <?php
        ...
        $sql = "INSERT INTO registration (fname, lname, email, adress) 
                VALUES ('$_POST[fname]', '$_POST[lname]', '$_POST[email]', '$_POST[adress]')";
        ...
        echo '<dl>';
        echo '<dt>Full Name</dt><dd>' . $_POST['fname'], " ", $_POST['lname'] . '</dd>';
        echo '<dt>Email</dt><dd>' . $_POST['email'] . '</dd>';
        echo '<dt>Address</dt><dd>' . $_POST['adress'] . '</dd>';
        echo '</dl>';
